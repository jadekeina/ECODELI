  ...
  useEffect(() => {
    axios.get(`${API_URL}/api/users/`)
      .then(res => {
        ...
        const livreurs = res.data.users.filter((user: any) => user.role === 'delivery-driver');
        setUsers(livreurs);
      })
  ...
  return (
    <div className="p-6 bg-gray-50">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Consultez et gérez tous les livreurs de la plateforme</p>
      </div>
      <UsersTable
        usersApi={users}
        showEmail={true}
