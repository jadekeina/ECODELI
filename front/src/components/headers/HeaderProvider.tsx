    ...
    <>
      ...
      <header className="w-full bg-white px-6 py-4 flex justify-between items-center shadow text-[#1a1a1a] text-lg relative z-50">
        ...
        <nav className="hidden lg:flex gap-10 font-semibold">
          <Link to="/prestations" className="hover:text-[#1B4F3C]">
            Mes prestations
          </Link>
          <Link to="/offres-prestations" className="hover:text-[#1B4F3C]">
            Offres disponibles
          </Link>
          <Link to="/annonces" className="hover:text-[#1B4F3C]">
            Toutes les offres
          </Link>
        </nav>
