...
const Header = () => {
  ...
  return (
    <header
      className={`w-full font-outfit-regular ${isAuthPage ? "bg-white text-[#155250] font-outfit-bold" : "text-[#1B4F3C]"} h-20 px-6 flex items-center justify-between shadow-sm`}
    >
      {/* Logo */}
      ...
      {!isAuthPage && (
        <nav className="flex gap-10 text-md font-outfit-medium items-center">
          <Link
            to="/NosEngagements"
            className="hover:text-[#155250] transition"
          >
            Nos engagements
          </Link>
