  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="space-y-2">
        ...
        <p>
          <strong>Trajet :</strong> {annonce.adresse_depart} ➡️{" "}
        ...
        <p>
          <strong>Dimensions :</strong> {annonce.longueur} x {annonce.largeur}{" "}
          cm
        </p>
        <p>
          <strong>Date demandée :</strong>{" "}
          {new Date(annonce.date_demande).toLocaleDateString("fr-FR")}
        </p>
