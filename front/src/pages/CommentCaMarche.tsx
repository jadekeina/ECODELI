    ...
    <div className="bg-[#f7faf9] text-[#142D2D]">
      ...
      <section className="flex flex-col-reverse md:flex-row items-center justify-between bg-[#1a6350]/10 w-full gap-10 px-10 py-20">
        <div className="w-full md:w-1/2 px-10">
          ...
          <p className="mb-6 text-gray-700 leading-relaxed">
            Bienvenue chez <strong>EcoDeli</strong>, la plateforme de
            crowdshipping qui connecte les besoins de chacun avec la communauté
            !
          </p>
      ...
      <section className="px-6 md:px-20 py-12 space-y-10">
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h3 className="text-xl font-semibold mb-2 text-[#1a6350]">
            🔒 La sécurité sur EcoDeli
          </h3>
          <p className="text-gray-600">
            Vérifications, messagerie sécurisée, évaluations et assurance pour
            vos services.
          </p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h3 className="text-xl font-semibold mb-2 text-[#1a6350]">
            🌱 Notre impact social & environnemental
          </h3>
          <p className="text-gray-600">
            EcoDeli favorise l'entraide locale tout en limitant l’empreinte
            carbone.
          </p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h3 className="text-xl font-semibold mb-2 text-[#1a6350]">
            🛍️ Devenir commerçant partenaire
          </h3>
          <p className="text-gray-600">
            Proposez la livraison de vos produits grâce à notre service "Lâcher
            de Chariot".
          </p>
        </div>
      </section>
