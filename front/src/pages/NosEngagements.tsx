  ...
  return (
    <div className="">
      <div className="flex flex-col items-center justify-center bg-[#1a6350]/10 w-full  py-18">
        ...
        <div>
          <p className="font-light text-[#142D2D] leading-tight px-55 ">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam
            recusandae possimus repudiandae voluptates ducimus fugit quibusdam
            ipsa repellat, consectetur, ea quam cumque tenetur. Illum
            praesentium natus porro tenetur, eaque nam.
          </p>
        </div>

        <div className="mt-4  ">
          <img src={PortraitPro} className="w-200  rounded-xl" alt="" />{" "}
        </div>
      </div>
        ...
        <div className=" flex m-5 justify-center items-center px-40 ">
          ...
          <div className="px-30">
            ...
            <p>
              ...
              Laboriosam recusandae possimus repudiandae voluptates ducimus
              fugit quibusdam ipsa repellat, consectetur, ea quam cumque
              tenetur. Illum praesentium natus porro tenetur, eaque nam.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center justify-center bg-[#155250] w-full py-38"></div>
        ...
        <section className="py-10 px-4 md:px-12 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-24">
            ...
            <div className="bg-gray-50 p-6 rounded-xl text-center">
              ...
              <p className="text-sm text-gray-600">
                Notre volonté de vous aider va au-delà des risques. Nous mettons
                un point d’honneur à nous dépasser au quotidien pour vous
                proposer le meilleur outil.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl text-center">
              ...
              <p className="text-sm text-gray-600">
                Nos différences font notre force. En interne ou avec nos
                clients, nous nous adaptons à chaque besoin pour progresser et
                devenir partenaire de votre réussite.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl text-center">
              ...
              <p className="text-sm text-gray-600">
                Nous avons la force d’avoir une équipe aux compétences multiples
                et unie par une même volonté : agir au service des entrepreneurs
                !
              </p>
            </div>
          </div>
          ...
          <div className="max-w-[65em] mx-auto bg-[#155250] text-white rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex-1 text-left">
              ...
              <p className="mb-6">
                Vous souhaitez rejoindre l’aventure Ecodeli ? Partagez-nous
                votre candidature.
              </p>
