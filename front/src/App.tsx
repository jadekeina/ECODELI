...
const stripePromise = loadStripe(
  "pk_test_51RgCcfCSsQb1TgL54ywb1mfMDkdW7cHbFpqW02CZxIVBWN4UXMmmqc02RQqPFUwf0KKfJbf4qPX3jKml2ODXRug700BoaMX9CN",
);
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              {user?.role === "client"
                ? renderWithLayout(<AccueilClient />)
                : renderWithLayout(<AppHome />)
              }
            </ProtectedRoute>
          }
        />
        <Route
          ...
          element={
            <ProtectedRoute>
              {user?.role === "client"
                ? renderWithLayout(<DashboardClient />)
        ...
        <Route
          path="/mon-compte"
          element={
            <ProtectedRoute>{renderWithLayout(<Account />)}</ProtectedRoute>
          }
        />
        <Route
          path="/history"
          element={
            <ProtectedRoute>{renderWithLayout(<History />)}</ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <RoleRoute allowedRoles={["client"]}>
                {renderWithLayout(<Trajet />)}
              </RoleRoute>
            </ProtectedRoute>
          }
        />
        <Route
          path="/confirmation-trajet"
          element={
            <ProtectedRoute>
              <RoleRoute allowedRoles={["client"]}>
                {renderWithLayout(<ConfirmationTrajet />)}
              </RoleRoute>
            </ProtectedRoute>
          }
        />
          ...
          element={
            <ProtectedRoute>
              <RoleRoute allowedRoles={["provider"]}>
                {renderWithLayout(<MesPrestations />)}
              </RoleRoute>
            </ProtectedRoute>
          }
        />
        <Route
          ...
          element={
            <ProtectedRoute>
              <RoleRoute
                allowedRoles={["provider", "delivery_driver", "shop_owner"]}
              >
                {renderWithLayout(<Requests />)}
              </RoleRoute>
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <RoleRoute allowedRoles={["client"]}>
                {renderWithLayout(<CreateAnnonce />)}
              </RoleRoute>
            </ProtectedRoute>
          }
        />
        <Route
          path="/deposer-contenu"
          element={
            <ProtectedRoute>
              <RoleRoute allowedRoles={["client"]}>
                {renderWithLayout(<DeposerContenu />)}
              </RoleRoute>
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute>{renderWithLayout(<RegisterPro />)}</ProtectedRoute>
          }
        />
        <Route
          path="/requests/:id"
          element={
            <ProtectedRoute>
              {renderWithLayout(<RequestDetails />)}
            </ProtectedRoute>
          }
        />
      </Routes>
